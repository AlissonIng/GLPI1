...
{
    // Preservar el nombre del solicitante
...
public static function showMassiveActionAddFollowupForm()
{
    ...
    // Aquí eliminamos el botón de envío
    echo "<tr class='tab_bg_2'>";
    echo "<td class='center' colspan='2'>";
    echo "<input type='hidden' name='is_private' value='" . $_SESSION['glpifollowup_private'] . "'>";
    // Si deseas que el formulario se envíe automáticamente, puedes agregar un script o lógica para manejar eso
    echo "</td>";
    echo "</tr>";
