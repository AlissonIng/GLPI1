   ...
   // From CommonDBTM
    ...
    public function getAdditionalFields()
    {
        $tab = [
            ...
            [
                'name'      => 'is_requirement',
                'label'     => __('Visible for a requirement'),
                'type'      => 'bool',
                'list'      => true,
            ],
        ...
        $tab = array_merge(
            ...
            [
                ...
                [
                    'name'  => 'tickettemplates_id_request',
                ...
                [
                    'name'  => 'tickettemplates_id_requirement',
                    'label' => __('Template for an requirement'),
                    'type'  => 'dropdownValue',
                    'list'  => true,
                ],
    ...
    public function rawSearchOptions()
    {
        ...
        $tab[] = [
            'id'                 => '76',
            'table'              => $this->getTable(),
            'field'              => 'is_requirement',
            'name'               => __('Visible for a requirement'),
            'datatype'           => 'bool'
        ];
    ...
    public static function showForITILTemplate(ITILTemplate $tt, $withtemplate = 0)
    {
        ...
        $iterator = $DB->request([
            ...
            'WHERE'  => [
                'OR' => [
                    'tickettemplates_id_request'     => $ID,
                    'tickettemplates_id_incident'   => $ID,
                    'tickettemplates_id_requirement'=> $ID,
