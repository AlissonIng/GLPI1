 ...
 public $requester_custom_name;
     ...
     public function post_addItem()
    {
        ...
        $input = [
         ...
         // Asignar el nombre del solicitante desde la base de datos
    $this->fields['requester_custom_name'] = isset($_POST['requester_custom_name']) ? $_POST['requester_custom_name'] : $ticket->fields['requester_custom_name'];

    // Asegúrate de que `requester_custom_name` esté en `item`
    $item['requester_custom_name'] = $this->fields['requester_custom_name'];
        ...
        $ticket->update($input);
        parent::post_addItem(); // Llamar al método de la clase padre
    }
