...
case 'notclosed':
    ...
    // Primero, obtenemos los estados de cerrado y cancelado
    $closedStatuses = $item->getClosedStatusArray();
    $cancelledStatuses = $item->getCancelledStatusArray();
    
    // Unimos ambos arrays en uno solo para tener una lista de todos los estados cerrados y cancelados
    $excludeStatuses = array_merge($closedStatuses, $cancelledStatuses);
    
    // Eliminamos los estados cerrados y cancelados de la lista de estados a revisar
    ...
    // Finalmente, obtenemos las claves de los estados que no están cerrados ni cancelados
