...
class PluginOrderNotificationTargetOrder extends NotificationTarget
{
    ...
    public function getEvents()
    {
        return [
            ...
            'delivered'      => __("Pedido Entregado", "order"),
            'statechanged'  => __("Order state changed", "order")
        ];
    }
    ...
    public function addDataForTemplate($event, $options = [])
    {
        ...
        if ($event == 'duedate') {
            ...
            switch ($event) {
                ...
                case "statechanged":
                    $this->data['##lang.ordervalidation.users##'] = __("State Changed", "order");
                    break;
...
##ordervalidation.entity##';
    ...
    public static function uninstall()
    {
        ...
        foreach (['ask', 'validation', 'cancel', 'undovalidation', 'duedate', 'delivered', 'statechanged'] as $event) {
            $options = [
                'itemtype' => 'PluginOrderOrder',
                'event'    => $event,
                'FIELDS'   => 'id',
