...
function plugin_order_add_css() {
    echo "<link rel='stylesheet' type='text/css' href='".GLPI_ROOT."/marketplace/order/order.css'>";
}
...
function plugin_order_getDropdown()
{
   /* table => name */
    ...
    if ($plugin->isActivated("order")) {
        return ['PluginOrderOrderPayment'     => __("Payment conditions", "order"),
            'PluginOrderOrderType'        => __("Área"),
        ...
        case "glpi_plugin_order_references.types_id":
            ...
            if (file_exists($file)) {
                return Dropdown::getDropdownName(
                    getTableForItemType($itemtype . "Área"),
                    $itemnum
                );
            } else {
                return " ";
