...
class __TwigTemplate_cb23c3e06e082788e9a1354effed6836 extends Template
{
    private $source;
    private $macros = [];
...
{% if display_actortypes is not defined %}
   {% set display_actortypes = ['requester', 'requester name', 'assign'] %}
{% endif %}
...
{% if display_labels %}
   {{ fields.field(
      'requester_custom_name', 
      requester_custom_field, 
      __('Nombre del solicitante'), 
      actor_options|merge({
         required: itiltemplate.isMandatoryField('_requester_custom_name')
      })
   ) }}
{% else %}
   {{ requester_custom_field }}
...
", "components/itilobject/actors/main.html.twig", "/var/www/glpi/templates/components/itilobject/actors/main.html.twig");
    }
}
