...
class __TwigTemplate_3b6da7849d450d10b859f012d0f7df6f extends Template
{
    private $source;
    private $macros = [];
...
($context["enable_anonymization"] ?? null)]);
      ...
      <div class=\"col-auto ms-2\">
        ...
        if (((($__internal_compile_26 = ($context["user"] ?? null)) && is_array($__internal_compile_26) || $__internal_compile_26 instanceof ArrayAccess ? ($__internal_compile_26["usercategories_id"] ?? null) : null) > 0)) {
            // line 97
            yield "               <div title=\"";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(_n("햞ea", "햞ea", 1), "html", null, true);
            yield "\" data-bs-toggle=\"tooltip\" data-bs-placement=\"top\">
      ...
      <div class=\"col-auto ms-2\">
         ...
         <div class=\"text-muted\">
            ...
            {% if user['usertitles_id'] > 0 %}
               <div title=\"{{ _x('person', 'Cargo') }}\" data-bs-toggle=\"tooltip\" data-bs-placement=\"top\">
                  <i class=\"fas fa-fw fa-user-tie\"></i>
                  {{ get_item_name('UserTitle', user['usertitles_id']) }}
               </div>
            {% endif %}
            {% if user['usercategories_id'] > 0 %}
               <div title=\"{{ _n('햞ea', '햞ea', 1) }}\" data-bs-toggle=\"tooltip\" data-bs-placement=\"top\">
                  <i class=\"fas fa-fw fa-user-tag\"></i>
...
", "components/user/info_card.html.twig", "/var/www/glpi/templates/components/user/info_card.html.twig");
    }
}
