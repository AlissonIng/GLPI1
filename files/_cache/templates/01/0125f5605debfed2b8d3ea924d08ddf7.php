...
class __TwigTemplate_ba45463ff1e6b76325fb2e581b502d13 extends Template
{
    private $source;
    private $macros = [];
...
($context["flags_html"] ?? null), _n("Port", "Ports", Session::getPluralNumber())], 66, $context, $this->getSourceContext());
    ...
    {
        return new Source("", "pages/assets/printer.html.twig", "/var/www/glpi/templates/pages/assets/printer.html.twig");
    }
}
