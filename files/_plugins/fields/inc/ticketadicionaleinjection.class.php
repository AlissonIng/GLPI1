...
class PluginFieldsTicketadicionaleInjection extends PluginFieldsTicketadicionale implements PluginDatainjectionInjectionInterface
{
    ...
    **/
    ...
    static function getTypeName($nb = 0) {
        return Ticket::getTypeName() . " - Adicionales";
    }
    ...
    **/
    function getOptions($primary_type='') {
        $searchoptions = PluginFieldsContainer::getAddSearchOptions('Ticket', 1);
