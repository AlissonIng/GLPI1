...
class PluginFieldsMotivodeesperafieldDropdown extends CommonTreeDropdown {
   public $field_name      = "motivodeesperafield";
   ...
   static function install() {
      ...
      if (!$DB->tableExists($table)) {
         $query = "CREATE TABLE IF NOT EXISTS `$table` (
                  ...
                  `plugin_fields_motivodeesperafielddropdowns_id` INT            {$default_key_sign} DEFAULT NULL,
                  ...
                  KEY                                       `plugin_fields_motivodeesperafielddropdowns_id`
                                                            (`plugin_fields_motivodeesperafielddropdowns_id`)
