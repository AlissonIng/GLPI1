...
echo "<style type='text/css'> body { background-image: url(pics/Background.png); background-repeat: no-repeat; background-size: cover; background-position: top center; } body.welcome-anonymous .card{background-color: rgba(57, 126, 192, 0.5); color: white; } </style></body></html>";
//echo "<style type='text/css'>body { margin: 0; padding: 0; height: 100vh; width: 100vw; background-image: url(pics/Background.png); background-repeat: no-repeat; background-size: cover; background-position: top center;} @media (max-width: 768px) { body { background-size: contain; background-position: top center; }} body.welcome-anonymous .card { background-color: rgba(57, 126, 192, 0.5); color: white; }</style></body></html>";
